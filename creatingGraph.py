...
def creatingGraph(Graph,minNumber = 0 ,maxNumber = 100):
    f1 = open("facebook_agm_small_tcl_aid.attr","r")
    f2 = open("facebook_agm_small_tcl_aid.lab","r")
    f3 = open("facebook_agm_small_tcl_aid.edges", "r")
    #/Users/ishaniGupta/Library/Mobile Documents/com~apple~CloudDocs/UCSB_1/Network Science/Project/Code/facebook_agm_small_tcl_aid
